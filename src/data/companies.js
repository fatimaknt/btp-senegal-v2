...
export const getCompaniesByCity = (city) => {
    return companiesData.filter(company => company.city.toLowerCase() === city.toLowerCase());
};
export const getCompaniesByCategory = (category) => {
    return companiesData.filter(company => company.category.toLowerCase() === category.toLowerCase());
};
export const searchCompanies = (query) => {
    const lowercaseQuery = query.toLowerCase();
    return companiesData.filter(company => company.name.toLowerCase().includes(lowercaseQuery) ||
