...
const BlogSection = () => {
    ...
    return (_jsx("section", {
        className: "py-20 bg-white", children: _jsxs("div", {
            className: "container mx-auto px-4", children: [_jsxs(motion.div, { initial: { opacity: 0, y: 30 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true }, transition: { duration: 0.6 }, className: "text-center mb-16", children: [_jsx("h2", { className: "text-3xl md:text-4xl font-heading font-bold text-gray-900 mb-4", children: "Actualit\u00E9s et conseils BTP" }), _jsx("p", { className: "text-xl text-gray-600 max-w-3xl mx-auto", children: "Restez inform\u00E9 des derni\u00E8res tendances, r\u00E9glementations et bonnes pratiques du secteur BTP au S\u00E9n\u00E9gal." })] }), _jsx(StaggerList, {
                className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12", children: articles.map((article) => (_jsx(motion.div, {
                    whileHover: { y: -5 }, transition: { duration: 0.2 }, children: _jsx("div", {
                        onClick: () => navigate(`/blog/${article.id}`),
                        className: "cursor-pointer"
                    }, children: _jsxs(Card, {
                        className: "overflow-hidden hover:shadow-lg transition-shadow duration-300 h-full", children: [_jsxs("div", {
                            className: "relative h-48 overflow-hidden", children: [_jsx("img", {
                                src: article.image, alt: article.title, className: "w-full h-full object-cover hover:scale-105 transition-transform duration-300", onError: (e) => {
                                    e.currentTarget.src = `https://images.unsplash.com/photo-1541888946425-d81bb19240f5?w=400&h=300&fit=crop`;
                                }
                            }), _jsx("div", { className: "absolute top-4 left-4", children: _jsx("span", { className: "bg-primary text-white px-3 py-1 rounded-full text-xs font-medium", children: article.category }) }), _jsxs("div", { className: "absolute top-4 right-4 bg-black bg-opacity-50 text-white px-2 py-1 rounded text-xs flex items-center space-x-1", children: [_jsx(Clock, { className: "h-3 w-3" }), _jsx("span", { children: article.readTime })] })]
                        }), _jsxs(CardContent, {
                            className: "p-6", children: [_jsx("h3", { className: "text-xl font-semibold text-gray-900 mb-3 line-clamp-2 hover:text-primary transition-colors", children: article.title }), _jsx("p", { className: "text-gray-600 text-sm mb-4 line-clamp-3", children: article.excerpt }), _jsxs("div", { className: "flex items-center justify-between text-sm text-gray-500 mb-4", children: [_jsx("div", { className: "flex items-center space-x-3", children: _jsxs("div", { className: "flex items-center space-x-1", children: [_jsx(User, { className: "h-4 w-4" }), _jsx("span", { children: article.author })] }) }), _jsxs("div", { className: "flex items-center space-x-1", children: [_jsx(Calendar, { className: "h-4 w-4" }), _jsx("span", { children: formatDate(article.publishedAt) })] })] }), _jsxs(Button, {
                                variant: "outline",
                                size: "sm",
