...
const HomePage = () => {
    ...
    return (_jsxs(PageTransition, {
        children: [_jsx(Box, {
            sx: {
                ...
                maxWidth: "lg", children: [_jsxs(Box, {
                    ...
                    sx: { maxWidth: 800, mx: 'auto', mb: 1 }, children: _jsx(Card, {
                        sx: {
        ...
        }), _jsx(Container, { maxWidth: "lg", sx: { py: 6 }, children: _jsx(AdSection, { title: "Publicit\u00E9s Sp\u00E9cialis\u00E9es BTP", maxAds: 3, showTitle: true }) }), _jsx(Box, {
            sx: {
