    ...
    return (_jsxs(Box, { sx: { backgroundColor: '#f8fafc', minHeight: '100vh' }, children: [_jsx(Box, { sx: {
                    ...
                    py: 8
                                ...
                                border: '1px solid rgba(255, 255, 255, 0.2)',
                                        ...
                                        }, children: "Appliquer les filtres" })] })] }) }) })), _jsxs(Container, { maxWidth: "lg", sx: { py: 6 }, children: [_jsxs(Box, { sx: { mb: 4, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }, children: [_jsxs(Typography, { variant: "h5", sx: { fontWeight: 600, color: '#1f2937' }, children: [filteredEnterprises.length, " entreprises trouv\u00E9es"] }), _jsx(Box, { sx: { display: 'flex', gap: 1, flexWrap: 'wrap' }, children: ['Vérifiées', 'Mieux notées', 'À proximité'].map((filter) => (_jsx(Chip, { label: filter, clickable: true, sx: {
                                        backgroundColor: 'rgba(249, 115, 22, 0.1)',
                                        color: '#f97316',
                                        '&:hover': {
                                            backgroundColor: 'rgba(249, 115, 22, 0.2)',
                                        }
                                    } }, filter))) })] }), _jsx(Grid, { container: true, spacing: 3, children: filteredEnterprises.map((enterprise) => (_jsx(Grid, { item: true, xs: 12, md: 6, lg: 4, children: _jsx(Card, { sx: {
                                    height: '100%',
                                    ...
                                    '&:hover': {
                                        ...
                                        boxShadow: '0 15px 35px rgba(249, 115, 22, 0.15)',
                                                        ...
                                                        height: 56
                                                                        ...
                                                                        minWidth: '24px',
                                                                        height: '24px'
                                                                    } }))] }), _jsx(Typography, { variant: "body2", color: "text.secondary", sx: { mb: 1 }, children: enterprise.category }), _jsxs(Box, { sx: { display: 'flex', alignItems: 'center', gap: 1 }, children: [_jsx(Rating, { value: enterprise.rating || 4.5, precision: 0.1, size: "small", readOnly: true }), _jsxs(Typography, { variant: "body2", color: "text.secondary", children: [enterprise.rating?.toFixed(1), " (", enterprise.reviews, " avis)"] })] })] })] }), _jsx(Typography, { variant: "body2", sx: { mb: 2, color: 'text.secondary' }, children: enterprise.description }), _jsx(Box, { sx: { mb: 2 }, children: _jsx(Box, { sx: { display: 'flex', flexWrap: 'wrap', gap: 0.5 }, children: enterprise.services?.map((service, index) => (_jsx(Chip, { label: service, size: "small", sx: {
                                                        backgroundColor: 'rgba(249, 115, 22, 0.1)',
                                                        color: '#f97316',
                                                    } }, index))) }) }), _jsxs(Box, { sx: { display: 'flex', alignItems: 'center', gap: 1, mb: 2 }, children: [_jsx(LocationIcon, { sx: { color: '#f97316', fontSize: 18 } }), _jsx(Typography, { variant: "body2", children: enterprise.address || 'Dakar' })] }), _jsxs(Box, { sx: { display: 'flex', alignItems: 'center', gap: 1, mb: 3 }, children: [_jsx(PhoneIcon, { sx: { color: '#f97316', fontSize: 18 } }), _jsx(Typography, { variant: "body2", children: enterprise.phone || enterprise.contact_phone || 'Aucun numéro' })] }), _jsx(Box, { sx: { display: 'flex', justifyContent: 'center' }, children: _jsx(Button, { variant: "contained", size: "medium", onClick: () => window.open(`https://wa.me/${enterprise.phone.replace(/\D/g, '')}`, '_blank'), sx: {
