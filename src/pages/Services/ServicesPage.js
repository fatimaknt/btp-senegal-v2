    ...
    return (_jsx(PageTransition, {
        children: _jsxs(Box, {
            sx: { backgroundColor: '#f8fafc', minHeight: '100vh' }, children: [_jsx(Box, {
                sx: {
                    background: 'linear-gradient(135deg,rgb(247, 131, 36) 0%,rgb(250, 157, 58) 100%)',
                    py: 8,
                    color: 'white'
                }, children: _jsx(Container, {
                    maxWidth: "lg", children: _jsxs(Box, {
                        sx: { textAlign: 'center' }, children: [_jsx(Typography, {
                            variant: "h2", sx: {
                                fontWeight: 700,
                                mb: 3,
                            ...
                            variant: "h5", sx: {
                                ...
                                mx: 'auto',
                                lineHeight: 1.6
                            }, children: "Des solutions compl\u00E8tes pour tous vos projets de construction et travaux publics"
                        })]
                    })
                })
            }), _jsx(Box, {
                sx: { py: 8 }, children: _jsx(Container, {
                    maxWidth: "lg", children: _jsx(Grid, {
                        container: true, spacing: 6, children: services.map((service, index) => (_jsx(Grid, {
                            item: true, xs: 12, md: 4, children: _jsxs(Card, {
                                sx: {
                                    height: '100%',
                                    borderRadius: 3,
                                    overflow: 'hidden',
                                    ...
                                    sx: { p: 4 }, children: [_jsx(Typography, {
                                        variant: "h4", sx: {
                                            fontWeight: 700,
                                            color: '#1f2937',
                                            mb: 2
                                        ...
                                        sx: { mb: 4 }, children: service.details.map((detail, detailIndex) => (_jsxs(Box, {
                                            sx: {
                                                display: 'flex',
                                                alignItems: 'center',
                                                mb: 1.5
                                        ...
                                        variant: "contained", endIcon: _jsx(ArrowForwardIcon, {}), sx: {
                                            backgroundColor: '#e67e22',
                                            color: 'white',
                                            px: 4,
                                            py: 1.5,
                    ...
                    maxWidth: "lg", children: _jsxs(Box, {
                        sx: { textAlign: 'center' }, children: [_jsx(Typography, {
                            ...
                            variant: "h6", sx: {
                                ...
                                maxWidth: '600px',
                                mx: 'auto'
                            }, children: "Contactez-nous d\u00E8s aujourd'hui pour discuter de vos besoins et obtenir un devis personnalis\u00E9."
                        }), _jsxs(Box, {
                            sx: { display: 'flex', gap: 3, justifyContent: 'center', flexWrap: 'wrap' }, children: [_jsx(Button, {
